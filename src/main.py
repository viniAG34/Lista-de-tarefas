...
def main():
    ...
    match opcao:
        ...
        case 1:
            ...
            Funcoes_tarefa.salvar_tarefa(entrada_titulo, entrada_descricao)
    
    
    # Criar tarefas de exemplo
    tarefa1 = Funcoes_tarefa.salvar_tarefa("Estudar Python", "Padrões MVC")
    tarefa2 = Funcoes_tarefa.salvar_tarefa("Compras", "Leite, ovos, pão")
